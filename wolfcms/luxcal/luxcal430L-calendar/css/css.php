...
input[type='text'], input[type='password'], textarea {padding:1px 0 0 2px; font:".FONT2."; cursor:text;}
input[type='radio'], input[type='checkbox'] {position:relative; top:3px; margin-right:3px;}
input[type='submit'], input[type='button'], input[type='file'], button {font:".FONT3."; height:18px; padding:0 2px; border-radius:4px; cursor:pointer;}
select {padding:1px 2px 0; font:".FONT2."; height:17px;}
...
div.content {clear:both; position:absolute; left:0; top:48px; right:0; bottom:35px; padding:0 26px 0 10px;}
...
.// ---- admin pages -----
"
fieldset {width:100%; margin-bottom:10px; padding:15px; border:1px solid #888888; background:".BGND1."; border-radius:5px;}
