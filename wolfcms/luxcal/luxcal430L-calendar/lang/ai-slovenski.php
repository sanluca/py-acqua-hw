...
"optionsPanel_text" => "Vključi/izključi menije v kontrolni plošči.<br>• The calendar menu is available to the admin to switch calendars. (enabling only useful if several calendars are installed)<br>• The groups menu can be used to display only events created by users in the selected groups.<br>• Uporabniški filter je lahko uporabljen za prikazovanje samo tistih dogodkov, ki so narejeni od enega specifičnega uporabnika.<br>• Filter za kategorije je lahko uporabljen za prikazovanje samo tistih dogodkov, ki spadajo v specifično kategorijo<br>• Meni za izbiranje jezika je lahko uporabljen za izbiranje jezika za uporabniški vmesnik.(Vključenje te možnosti je samo takrat koristno, ko je nameščenih več jezikov)",
