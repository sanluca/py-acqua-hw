...
"optionsPanel_text" => "Вкл/выкл меню в панели опций.<br>• Меню календаря доступно админу для переключения между календарями. (актуально при установке нескольких календарей)<br>• The groups menu can be used to display only events created by users in the selected groups.<br>• Меню пользователя отображается только создателю.<br>• Меню категорий используется для отображения событий конкретной категории.<br>• Языковое меню служит для переключения между языками интерфейса. (актуально при использовании нескольких языков)",
...
"selfRegGrp_text" => "Пользовательская группа, к которой добавляется новый пользователь.",
...
"grp_not_added" => "Группа не добавлена",
"grp_not_updated" => "Группа не обновлена",
