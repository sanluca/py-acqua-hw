...
"optionsPanel_text" => "Het weergeven van menus in the Instellingen.<br>• Het kalender menu is beschikbaar voor de admin en maakt het mogelijk om een kalender te kiezen. (inschakelen alleen relevant als meerdere kalenders zijn geïnstalleerd)<br>• Het groeps menu kan worden gebruikt om activiteiten weer te geven welke zijn ingevoerd door de gebruikers in de geselecteerde groepen.<br>• Het gebruikers menu kan worden gebruikt om activiteiten weer te geven welke zijn ingevoerd door de geselecteerde gebruikers.<br>• Het categorie menu kan worden gebruikt om activiteiten weer te geven welke tot de geselecteerde activiteitencategorieën behoren.<br>• Met het taalkeuze menu kan de taal van de gebruikersinterface worden gekozen. (inschakelen alleen relevant als meerdere talen zijn geïnstalleerd)",
...
"dwStartHour_text" => "Uur waarop een normale dag begint<br>Wanneer deze waarde op bijv. 6 wordt gesteld, wordt in de Dag/Week-weergave niet nodeloos ruimte gebruikt voor de tijd tussen middernacht en 6:00 uur waarop normaal niet veel wordt uitgevoerd.<br>De tijd kiezer, die wordt gebruikt bij het invoeren van een tijd, zal ook op dit uur beginnen.",
"dwEndHour_label" => "Einduur in Dag/Week weergave",
"dwEndHour_text" => "Uur waarop een normale dag eindigt.<br>Wanneer deze waarde op bijv. 18 wordt gesteld, wordt in de Dag/Week-weergave niet nodeloos ruimte gebruikt voor de tijd tussen 18:00 uur en middernacht.<br>De tijd kiezer, die wordt gebruikt bij het invoeren van een tijd, zal ook op dit uur eindigen.",
...
"dwTsHeight_label" => "Tijdspannet hoogte",
...
"grp_rep_events" => "Herhalende activiteiten",
"grp_m-d_events" => "Meerdags activiteiten",
"grp_priv_events" => "Privé activiteityen",
