...
"xFieldx_text" => "Nom d’un champ optionnel de texte. Si ce champ est inclus dans le panneau d’événement, à partir de maintenant le champ sera ajouté comme champ de texte de format libre dans le formulaire d’événement et dans les événements affichés dans toutes les vues et les pages du calendrier.<br>Le nom spécifié peut faire jusqu’à 15 caractères de long. Ex.: “Adresse email”, “Site Web”, “N° de téléphone”.",
"logged_in" => "connecté",
