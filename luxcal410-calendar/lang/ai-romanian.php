...
"optionsPanel_text" => "Activează/dezactivează modurile de afișare din meniul Opțiuni.<br>• The calendar menu is available to the admin to switch calendars. (enabling only useful if several calendars are installed)<br>• Meniul pentru utilizatori poate fi folosit pentru afișarea selectivă a evenimentelor corespunzătoare anumitor utilizatori.<br>• Meniul pentru categorie poate fi folosit similar pentru afișarea selectivă doar a anumitor categorii de evenimente.<br>• Meniul de selecție a limbii permite definirea limbii de afișare a calendarului (doar dacă calendarul are mai multe fișiere de limbă instalate)",
