...
<p>This test mail was sent from your calendar's Settings page</p>
<br>
<p><a href='{$pSet['calendarUrl']}'>{$ax['cro_open_calendar']}</a></p>
</body>
</html>
";
	$recipient = sendMail('LuxCal test mail', $msgText, $pSet['calendarEmail']);
...
echo "<fieldset><legend>{$ax['set_general_settings']}</legend>
	...
	<div class='sValue'>".LCV." - {$dbDir}{$calID}.cdb</div><br>
...
echo "<fieldset><legend>{$ax['set_navbar_settings']}</legend>
	...
	<div class='sValue'><input type='checkbox' id='todo' name='pSet[navTodoList]' value='1'".($pSet['navTodoList'] == 1 ? " checked='checked'" : '')."><label for='todo'>{$ax['navTodoList_label']}</label>&nbsp;&nbsp;
...
echo "<fieldset><legend>{$ax['set_event_settings']}</legend>
	...
	<div class='sValue'><input type='text' name='pSet[xField1]' maxlength='15' size='12' value=\"{$pSet['xField1']}\"></div><br>
	
	<div class='sLabel' onmouseover=\"pop(this,'".htmlspecialchars($ax['xFieldx_text'])."', 'normal')\">{$ax['xField2_label']}:</div>
	<div class='sValue'><input type='text' name='pSet[xField2]' maxlength='15' size='12' value=\"{$pSet['xField2']}\"></div><br>
</fieldset>\n";
echo "<fieldset><legend>{$ax['set_user_settings']}</legend>
	...
	<div class='sValue'><input type='checkbox' onclick=\"xxable('SREG','x');\" name='pSet[selfReg]' value='1'".($pSet['selfReg'] == 1 ? " checked='checked'" : '')."></div><br>

	<div class='sLabel' onmouseover=\"pop(this,'".htmlspecialchars($ax['selfRegGrp_text'])."', 'normal')\">{$ax['selfRegGrp_label']}:</div>
	<div class='sValue'><select class='SREG' name='pSet[selfRegGrp]'".($pSet['selfReg'] != 1 ? " disabled" : '').">\n";
	...
	while ($row = $stH->fetch(PDO::FETCH_ASSOC)) {
		if ($row['ID'] != 2) {
			...
			$selected = $row['ID'] == $pSet['selfRegGrp'] ? " selected='selected'" : '';
	...
	<div class='sValue'><input type='checkbox' class='SREG' name='pSet[selfRegNot]' value='1'".($pSet['selfRegNot'] == 1 ? " checked='checked'" : '')."".($pSet['selfReg'] != 1 ? " disabled" : '')."></div><br>
...
echo "<fieldset><legend>{$ax['set_view_settings']}</legend>
	...
	<div class='sLabel' onmouseover=\"pop(this,'".htmlspecialchars($ax['showLinkInMV_text'])."', 'normal')\">{$ax['showLinkInMV_label']}:</div>
	<div class='sValue'><input type='checkbox' name='pSet[showLinkInMV]' value='1'".($pSet['showLinkInMV'] == 1 ? " checked='checked'" : '')."></div><br>
...
echo "<fieldset><legend>{$ax['set_email_settings']}</legend>
	...
	<div class='sValue'><input type='radio' onclick=\"xxable('SMTP',true);\" id='mails0' name='pSet[mailServer]' value='0'".($pSet['mailServer'] == 0 ? " checked='checked'" : '')."><label for='mails0'>{$ax['disabled']}</label>&nbsp;&nbsp;&nbsp;
	<input type='radio' onclick=\"xxable('SMTP',true);\" id='mails1' name='pSet[mailServer]' value='1'".($pSet['mailServer'] == 1 ? " checked='checked'" : '')."><label for='mails1'>{$ax['php_mail']}</label>&nbsp;&nbsp;&nbsp;
	<input type='radio' onclick=\"xxable('SMTP',false);\" id='mails2' name='pSet[mailServer]' value='2'".($pSet['mailServer'] == 2 ? " checked='checked'" : '')."><label for='mails2'>{$ax['smtp_mail']}</label></div><br>

	<div class='sLabel' onmouseover=\"pop(this,'".htmlspecialchars($ax['smtpServer_text'])."', 'normal')\">{$ax['smtpServer_label']}:</div>
	<div class='sValue'><input type='text'{$errors[$i++]} class='SMTP' name='pSet[smtpServer]' size='45' value='{$pSet['smtpServer']}'".($pSet['mailServer'] != 2 ? " disabled" : '')."></div><br>

	<div class='sLabel' onmouseover=\"pop(this,'".htmlspecialchars($ax['smtpPort_text'])."', 'normal')\">{$ax['smtpPort_label']}:</div>
	<div class='sValue'><input type='text'{$errors[$i++]} class='SMTP' name='pSet[smtpPort]' maxlength='5' size='4' value='{$pSet['smtpPort']}'".($pSet['mailServer'] != 2 ? " disabled" : '')."></div><br>

	<div class='sLabel' onmouseover=\"pop(this,'".htmlspecialchars($ax['smtpSsl_text'])."', 'normal')\">{$ax['smtpSsl_label']}:</div>
	<div class='sValue'><input type='checkbox' class='SMTP' name='pSet[smtpSsl]' value='1'".($pSet['smtpSsl'] ? " checked='checked'" : '')."".($pSet['mailServer'] != 2 ? " disabled" : '')."></div><br>

	<div class='sLabel' onmouseover=\"pop(this,'".htmlspecialchars($ax['smtpAuth_text'])."', 'normal')\">{$ax['smtpAuth_label']}:</div>
	<div class='sValue'><input type='checkbox' class='SMTP' name='pSet[smtpAuth]' value='1'".($pSet['smtpAuth'] ? " checked='checked'" : '')."".($pSet['mailServer'] != 2 ? " disabled" : '')."></div><br>

	<div class='sLabel' onmouseover=\"pop(this,'".htmlspecialchars($ax['smtpUser_text'])."', 'normal')\">{$ax['smtpUser_label']}:</div>
	<div class='sValue'><input type='text'{$errors[$i++]} class='SMTP' name='pSet[smtpUser]' size='45' value='{$pSet['smtpUser']}'".($pSet['mailServer'] != 2 ? " disabled" : '')."></div><br>

	<div class='sLabel' onmouseover=\"pop(this,'".htmlspecialchars($ax['smtpPass_text'])."', 'normal')\">{$ax['smtpPass_label']}:</div>
	<div class='sValue'><input type='password'{$errors[$i++]} class='SMTP' name='pSet[smtpPass]' size='45' value='{$pSet['smtpPass']}'".($pSet['mailServer'] != 2 ? " disabled" : '')."></div><br>
</fieldset>\n";
